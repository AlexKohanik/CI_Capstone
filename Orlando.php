...
<?php
	...
	//Flights
		...
		echo "<h1>Flights departing From JFK to Orlando:</h1>";
        $sql3 = "SELECT id, depiataCode, arriataCode, terminal, gate, scheduledTime, name, number FROM aviation WHERE arriataCode = 'mco'";
	...
	//Yelp
		echo "<h1>Highly Rated Places in Orlando</h1>";
        $sql4 = "SELECT id, name, url, rating, street, city, zip FROM yelp WHERE city = 'Orlando'";
