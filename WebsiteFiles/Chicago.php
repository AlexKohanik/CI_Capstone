...
<?php
	...
	//Flights
		echo "<h1>Flights departing  from JFK to Chicago:</h1>";
        $sql3 = "SELECT id, depiataCode, arriataCode, terminal, gate, scheduledTime, name, number FROM aviation WHERE arriataCode = 'ord'";
	...
	//Yelp
		echo "<h1>Highly Rated Places in Chicago</h1>";
        $sql4 = "SELECT id, name, url, rating, street, city, zip FROM yelp WHERE city = 'Chicago'";
